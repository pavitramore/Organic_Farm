        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-white mb-md-4">Login</h1>
                    <a href="index.jsp" class="btn btn-primary py-md-3 px-md-5 me-3">Home</a>
                    <a href="reg.jsp" class="btn btn-secondary py-md-3 px-md-5">Sign-UP</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="mx-auto text-center mb-5" style="max-width: 500px;">
                <h2 class="text-primary text-uppercase">User-Login</h2>
            </div>
            <div class="row g-0">
                <div class="col-lg-7">
